...
public class CSCallLua : MonoBehaviour {
	...
	[CSharpCallLua]
	public delegate void LogDelegate(object obj);

	[CSharpCallLua]
	public delegate void CheckDelegate(TestData t0,TestData t1);
...
//        d_e.Call();
	...
	private void TestB()
	{
		TestData t1 = new TestData (1,1,111);
		TestData t2 = new TestData (2,2,222);
		check = luaenv.Global.Get<CheckDelegate> ("check");
		int i = 0;
...
//		}
	...
	{
		int i = 0;
		LogDelegate log = luaenv.Global.Get<LogDelegate> ("log");
//		while (i < 1000) {
			log ("aaaa");
//			i++;
//		}
...
public class TestData{
	...
	public TestData(int i,int t,int n)
	{
		id = i;
		type = t;
		num = n;
